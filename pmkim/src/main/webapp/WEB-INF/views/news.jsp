                ...
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button onclick = "/pmkim/news?shop_name_kor=cu">CU</button>
                            <button onclick = "/pmkim/news?shop_name_kor=GS25">GS25</button>
							<button onclick = "/pmkim/news?shop_name_kor=미니스톱">MiniStop</button>
							<button onclick = "/pmkim/news?shop_name_kor=세븐일레븐">7Eleven</button>
							<button onclick = "/pmkim/news?shop_name_kor=이마트24">Emart24</button>
                        </div>
                    </div>
                </div>
            </div>
